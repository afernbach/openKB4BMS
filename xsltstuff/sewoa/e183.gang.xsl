...
<xsl:template name="label" match="@displayName">
	<xsl:element name="rdfs:label">
		<xsl:attribute name="rdf:datatype"><xsl:text disable-output-escaping="yes"><![CDATA[&]]>xsd;string</xsl:text></xsl:attribute>	
...
<xsl:template name="roomtype" match="enum[@name='type']">
	...
	<xsl:attribute name="rdf:reference">	
        ...
        <xsl:when test="@val ='buildingpart'">
       		<xsl:text disable-output-escaping="yes"><![CDATA[&]]>EnergyResourceOntology;BuildingPart</xsl:text>
        </xsl:when>
        <xsl:when test="@val ='floor'">
       		<xsl:text disable-output-escaping="yes"><![CDATA[&]]>EnergyResourceOntology;BuildingStorey</xsl:text>
        </xsl:when>
        ...
        <xsl:when test="@val ='distributionboard'">
       		<xsl:text disable-output-escaping="yes"><![CDATA[&]]>EnergyResourceOntology;DistributionBoard</xsl:text>
        </xsl:when>
        <xsl:otherwise>
