    ...
    <xsl:template match="knx:ComObjectInstanceRef">
        ...
        <xsl:if test="knx:Connectors">
            <xsl:element name="datapoint">
                ...
                <xsl:variable name="group" select="knx:Connectors/knx:Send/@GroupAddressRefId"/>
                <xsl:variable name="groupAddressRefId" select="/knx:KNX/knx:Project/knx:Installations/knx:Installation/knx:GroupAddresses/knx:GroupRanges/knx:GroupRange/knx:GroupRange/knx:GroupAddress[@Id=$group]" />
                ...
                <xsl:attribute name="datapointTypeIds">
                    <xsl:choose>
                        ...
                        <xsl:when test="$groupAddressRefId/@DatapointType and not($groupAddressRefId/@DatapointType='')">
                            <xsl:value-of select="$groupAddressRefId/@DatapointType"/>
                        </xsl:when>
                        <xsl:otherwise>
