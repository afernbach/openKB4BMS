...
public class OnOffSwitchModelAdapterImpl implements ObixModelAdapter {
    ...
    public ModelType getModelType() {
        return ModelType.ON_OFF_SWITCH;
    }
    ...
    public void init(String prefix, HashMap<String, ObixIndividual> individuals, OntModel model, ObixWatcher obixWatcher, ObixUnitFactory obixUnitFactory) {
        ...
        Resource switchClass = ResourceFactory.createResource(BASE_ONTOLOGY_URL + getModelType().getType());
        ...
        while(individualExtendedIterator.hasNext()){
            ...
            individuals.put(object.toString().replace(prefix, ""), new ObixIndividual(individual, getModelType()));
